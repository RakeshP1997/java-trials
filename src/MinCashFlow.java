...
class MinCashFlow
{
    ...
    static String[] names = {"Keerti", "Rakesh", "Akanksha", "Jugal"};
    ...
    static void minCashFlowRec(int amount[])
    {
        ...
        System.out.println(getPersonName(mxDebit) + " pays " + min
                + " to " + getPersonName(mxCredit));
    ...
    static String getPersonName(int index) {
        return names[index];
    }
